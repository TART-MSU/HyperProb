...
def parseArguments():
    ...
    parser.add_argument('-modelPaths', nargs='+', required=True, help='path to the MDP/DTMC model file in PRISM language')
    ...
    parser.add_argument('--checkProperty', action='store_true', help='check if property can be parsed')
